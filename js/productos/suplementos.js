const productosSuplementos = [
    ...
    {
    id: "suplementos41",
    nombre: "GOTAS DIGESTIVAS X 60 CC",
    precio: "$5.100",
    descripcion: "Con la mezcla de estas hierbas (Boldo, Alcachofa y Carqueja) y el agregado de Selenio hemos obtenido un suplemento dietario digestivo y hepatoprotector por excelencia, de sabor fresco, ligeramente mentolado. 20 a 30 gotas después de las comidas y nunca más sensación de pesadez o digestiones lentas. Para adoptarlo como una buena costumbre!",
    imagen: "../img/sup25.webp",
    categoria: "suplementos",
    marca: "OTROS"
    },
    {
    id: "suplementos42",
    nombre: "GOTAS ADELGAZANTE X 60 CC",
    precio: "$6.600",
    descripcion: "Este suplemento dietario compuesto por hierbas de máxima calidad, posee propiedades antioxidantes (Té verde, Vid roja) y disminuye el colesterol (Té verde). Es ideal para mejorar la celulitis, a través de las propiedades circulatorias y vaso protectoras de la Centella asiática, la Vid Roja y el Grosellero negro. Favorece, además, la movilización en los tejidos grasos de los adipocitos gracias al extracto de Ananá. Genera sensación de saciedad y activa la velocidad del metabolismo, contribuyendo al descenso de peso. Aporta Vitamina C y Selenio, siendo ambos excelentes antioxidantes y desintoxicantes.",
    imagen: "../img/sup26.webp",
    categoria: "suplementos",
    marca: "OTROS"
    },
    {
